...
public class PDDL21parser implements PDDL21parserConstants {
	...
	private static boolean parseDomainFile(File pFile) {
		...
		try {
			...
			req = new PDDL21parser(tFileReader).parseDomain();
			tFileReader.close();
		...
		JavaFF.parsingOutput.println(
				req ? "Parsed Domain file " + pFile + " successfully" : "Parsing of Domain file " + pFile + " failed");
		return req;
	}
	...
	private static boolean parseProblemFile(File pFile) {
		...
		try {
			FileReader tFileReader = new FileReader(pFile);
			new PDDL21parser(tFileReader).parseProblem();
			tFileReader.close();
		} catch (FileNotFoundException e) {
			JavaFF.parsingOutput.println("File " + pFile + " has not been found");
			probsuc = false;
		...
		JavaFF.parsingOutput.println(probsuc ? "Parsed Problem file " + pFile + " successfully"
				: "Parsing Problem file " + pFile + " failed");
		return probsuc;
	}
	...
	public final boolean parseDomain() throws ParseException {
		Token t;
		boolean req = true;
	...
	public final boolean parseRequireDef() throws ParseException {
		Token t;
		jj_consume_token(OPEN);
	...
	public final void parseTypeDef() throws ParseException {
		Type t;
		Set types;
		jj_consume_token(OPEN);
	...
	public final SimpleType parsePrimitiveType() throws ParseException {
		Token t;
		t = jj_consume_token(NAME);
	...
	public final EitherType parseEitherType() throws ParseException {
	...
	public final TypedList parseTypedList() throws ParseException {
	...
	public final void parseConstantsDef() throws ParseException {
		TypedList tl;
		jj_consume_token(OPEN);
	...
	public final void parsePredicatesDef() throws ParseException {
		jj_consume_token(OPEN);
	...
	public final void parsePredicate() throws ParseException {
		PredicateSymbol ps;
		TypedList tl;
		jj_consume_token(OPEN);
	...
	public final PredicateSymbol parsePredicateSymbol() throws ParseException {
		Token t;
		t = jj_consume_token(NAME);
	...
	public final void parseStructureDef() throws ParseException {
		if (jj_2_24(20)) {
			parseActionDef();
		} else if (jj_2_25(20)) {
			parseDurActionDef();
	...
	public final void parseActionDef() throws ParseException {
	...
	public final OperatorName parseOperatorName() throws ParseException {
		Token t;
		t = jj_consume_token(NAME);
		{
			if (true)
	...
	public final void parseActionDefBody(UngroundInstantAction a, Map varMap) throws ParseException {
		Condition c;
		Effect e;
		if (jj_2_26(20)) {
	...
	public final Condition parseGD(Map m, boolean ground) throws ParseException {
		Literal p;
		Condition c;
		AND and;
		if (jj_2_29(20)) {
	...
	public final Literal parseAtomicFormula(Map m, boolean ground) throws ParseException {
		PredicateSymbol p;
		TypedList tl;
		jj_consume_token(OPEN);
	...
	public final Effect parseEffect(Map m) throws ParseException {
		Effect c;
		AND and;
		if (jj_2_34(20)) {
			jj_consume_token(OPEN);
	...
	public final Effect parseCEffect(Map m) throws ParseException {
		Effect p;
		p = parsePEffect(m);
		{
			if (true)
	...
	public final Effect parsePEffect(Map m) throws ParseException {
		Literal p;
		ResourceOperator ro;
		if (jj_2_37(20)) {
	...
	public final void parseFunctionsDef() throws ParseException {
		jj_consume_token(OPEN);
	...
	public final void parseFunctionSkeleton() throws ParseException {
		FunctionSymbol fs;
		TypedList tl;
		jj_consume_token(OPEN);
	...
	public final FunctionSymbol parseFunctionSymbol() throws ParseException {
		Token t;
		t = jj_consume_token(NAME);
	...
	public final BinaryComparator parseFComp(Map varMap) throws ParseException {
		Token t1;
		Function f1;
		Function f2;
		jj_consume_token(OPEN);
	...
	public final Function parseFExp(Map varMap) throws ParseException {
		Token t1;
		Function f1;
		Function f2;
		if (jj_2_41(20)) {
	...
	public final NamedFunction parseFHead(Map varMap) throws ParseException {
		FunctionSymbol f;
		TypedList tl;
		if (jj_2_48(20)) {
			jj_consume_token(OPEN);
	...
	public final ResourceOperator parseResourceOperator(Map varMap) throws ParseException {
		Token t1;
		NamedFunction f1;
		Function f2;
		jj_consume_token(OPEN);
	...
	public final void parseDurActionDef() throws ParseException {
	...
	public final void parseDurativeActionDefBody(UngroundDurativeAction da, Map varMap) throws ParseException {
	...
	public final void parseDAGD(UngroundDurativeAction da, Map varMap) throws ParseException {
		if (jj_2_52(20)) {
	...
	public final void parseTimedGD(UngroundDurativeAction da, Map varMap) throws ParseException {
		Condition c;
		if (jj_2_54(20)) {
			jj_consume_token(OPEN);
	...
	public final DurationConstraint parseDurationConstraint(UngroundDurativeAction da, Map varMap)
	...
	public final SimpleDurationConstraint parseSimpleDurationConstraint(UngroundDurativeAction da, Map varMap)
			throws ParseException {
		int t;
		Function f;
		jj_consume_token(OPEN);
	...
	public final int parseDOp() throws ParseException {
		Token t;
		if (jj_2_60(20)) {
		...
		if (i == MetricSymbolStore.lessThan)
			i = MetricSymbolStore.lessThanEqual;
		else if (i == MetricSymbolStore.greaterThan)
			i = MetricSymbolStore.greaterThanEqual;
		{
			if (true)
				return i;
		}
	...
	public final void parseDAEffect(UngroundDurativeAction da, Map varMap) throws ParseException {
		if (jj_2_63(20)) {
	...
	public final void parseTimedEffect(UngroundDurativeAction da, Map varMap) throws ParseException {
		Effect e;
		if (jj_2_65(20)) {
			jj_consume_token(OPEN);
			jj_consume_token(AT_START);
	...
	public final ResourceOperator parseFAssignDA(UngroundDurativeAction da, Map varMap) throws ParseException {
		Token t1;
		NamedFunction f1;
		Function f2;
		jj_consume_token(OPEN);
	...
	public final Function parseFExpDA(UngroundDurativeAction da, Map varMap) throws ParseException {
		Token t1;
		Function f1;
		Function f2;
		if (jj_2_69(20)) {
	...
	public final boolean parseProblem() throws ParseException {
		Token t;
		Token t2;
		jj_consume_token(OPEN);
		jj_consume_token(DEFINE);
	...
	public final void parseObjectDeclaration() throws ParseException {
		TypedList tl;
		jj_consume_token(OPEN);
	...
	public final void parseInit() throws ParseException {
		jj_consume_token(OPEN);
	...
	public final void parseInitEl() throws ParseException {
		Literal pp;
		NamedFunction nf;
		Token t1;
		if (jj_2_79(20)) {
	...
	public final Literal parseLiteralName() throws ParseException {
		Literal pp;
	...
	public final void parseGoal() throws ParseException {
		Condition e;
		jj_consume_token(OPEN);
	...
	public final void parseMetric() throws ParseException {
		int type;
		Function f1;
		jj_consume_token(OPEN);
	...
	public final int parseOptimization() throws ParseException {
		Token t1;
		t1 = jj_consume_token(OPTIMIZATION);
		if ("minimize".equals(t1.toString())) {
			if (true)
				return Metric.minimize;
		} else if ("maximize".equals(t1.toString())) {
			if (true)
	...
	private final JJCalls[] jj_2_rtns = new JJCalls[80];
	...
	public void ReInit(java.io.InputStream s) {
		jj_input_stream.ReInit(s, 1, 1);
